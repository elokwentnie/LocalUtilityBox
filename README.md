...
- [FFmpeg](https://ffmpeg.org/) (required for `video_to_gif` and `extract_audio_from_video`)
...
| Video / audio tools | [FFmpeg builds](https://www.gyan.dev/ffmpeg/builds/) — install and add `bin` folder to PATH |
